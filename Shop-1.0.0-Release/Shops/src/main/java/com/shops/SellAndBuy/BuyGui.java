...
public class BuyGui {
    public static Inventory inv(Material material, Player p) {
        ...
        Inventory inv = Bukkit.createInventory(null, 27, "BuyMenu");
        ...
        inv.setItem(13, SellAndBuyGuiItems.item(material, section.getInt("buy"), p));
        ...
        inv.setItem(22, SellAndBuyGuiItems.stack());
